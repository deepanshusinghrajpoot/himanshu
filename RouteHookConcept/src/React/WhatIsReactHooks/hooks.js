/*
    ...
    lll But after introducing React Hooks from version 16.8, we can now use *state management and *other react features without writing *class components.
     ...
     In other words, Hooks are the *functionas that make *functional components work like *class components.
     Hooks made react *fuctional component so easy to use.
     ...
     =================== Most commonaly used hooks are ===================

        1. useState                    1. useState
        2. useEffect                   2. useEffect 
        3. useRef                      3. useContext
        4. useMemo                     4. useReducer
        5. useCallback                 5. useMemo 
        6. useContext                  6. useCallback 
        7. useReducer                  7. useRef
