...
| Function                                     | Use                | Example                 | Result  |
| -------------------------------------------- | ------------------ | ----------------------- | ------- |
| lll `GROUP_CONCAT(col)` (MySQL)              | Merge group values | `GROUP_CONCAT(name)`    | `A,B,C` |
|lll`STRING_AGG(col, sep)`(SQL Server/Postgres)| Merge group values | `STRING_AGG(name, ',')` | `A,B,C` |
