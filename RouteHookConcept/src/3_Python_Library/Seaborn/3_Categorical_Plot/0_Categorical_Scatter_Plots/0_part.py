...
# sns.stripplot() -> axes level method -> rectangular 
#......................................................
...
sns.catplot(data=tips, x='day', y='total_bill', kind='strip', jitter=0)
...
sns.catplot(data=tips, x='day', y='total_bill', col='sex', kind='strip')
plt.show()