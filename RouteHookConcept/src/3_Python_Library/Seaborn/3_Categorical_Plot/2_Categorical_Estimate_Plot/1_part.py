...
# sns.countplot() -> axes level method -> rectangular  (violinplot = Boxplot + KDEplot)
#......................................................
...
sns.countplot(data=tips, x='sex')  # by default estimator=np.mean
...
sns.catplot(data=tips, x='sex', kind='count') # by default estimator=np.mean
...
sns.catplot(data=tips, x='sex', hue='day', kind='count')  # by default estimator=np.mean
...
sns.catplot(data=tips, x='day', col='sex',  kind='count')  # by default estimator=np.mean
plt.show()
