...
# kdetplot (Kernal Density Estimation)
#======================================

# Rather than using discrete bins, a KDE plot smoots the observations with a gaussian kernel, producing a continuous density estimate

# Y-axis repersent density of probability
...
sns.displot(data=tips, x='total_bill', col='sex', fill=True, kind='kde')
plt.show()